...
ARG PUBLIC_FOOD_ORDERS_API_URL=
ARG PUBLIC_DART_OPEN_PLAY_API_URL=
...
ENV DIRECTUS_URL=${DIRECTUS_URL} \
    ...
    PUBLIC_FOOD_ORDERS_API_URL=${PUBLIC_FOOD_ORDERS_API_URL} \
    PUBLIC_DART_OPEN_PLAY_API_URL=${PUBLIC_DART_OPEN_PLAY_API_URL} \
    NODE_ENV=production \
    CI=true
